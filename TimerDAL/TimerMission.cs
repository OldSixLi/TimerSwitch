...
namespace TimerDAL
{
	...
	public partial class TimerMission
	{
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(TimerModel.TimerMission model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(TimerManage.Model.TimerMission model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public TimerManage.Model.TimerMission GetModel(Guid ID)
		{
			...
			TimerManage.Model.TimerMission model=new TimerManage.Model.TimerMission();
		...
		/// 得到一个对象实体
		/// </summary>
		public TimerManage.Model.TimerMission DataRowToModel(DataRow row)
		{
			TimerManage.Model.TimerMission model=new TimerManage.Model.TimerMission();
			if (row != null)
			{
